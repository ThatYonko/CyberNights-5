...
![Screenshot (59)](https://github.com/ThatYonko/CyberNights-5/assets/107263975/8bca6bf9-1c52-40e4-832e-e3f96bba909a)
...
![Screenshot (58)](https://github.com/ThatYonko/CyberNights-5/assets/107263975/4d57eb68-0026-47e9-9f4a-3e52eb650610)

## Time for work
Ok, let's move the POST request to burp, firstly I tried array injection but I got `400 Bad request` :

![Screenshot (62)](https://github.com/ThatYonko/CyberNights-5/assets/107263975/e8db0192-9588-4f89-8206-2214056ab1fa)
...
![Screenshot (61)](https://github.com/ThatYonko/CyberNights-5/assets/107263975/c67cad68-eaa2-47c4-8224-4f462a19a035)

After playing with the query to find out what is exactly getting blocked by WAF I found that it's blocking any spaces :

![Screenshot (63)](https://github.com/ThatYonko/CyberNights-5/assets/107263975/57e31fe8-5f0b-4340-b5e5-d8cb20c1afcc)
...
![Screenshot (64)](https://github.com/ThatYonko/CyberNights-5/assets/107263975/4db04450-6b7b-49ea-9878-7bed8012c5a9)
...
![Screenshot (65)](https://github.com/ThatYonko/CyberNights-5/assets/107263975/23664a12-1ce9-408e-959a-06c7ab30c5e7)

It seems that also `--` is getting blocked. How did I know? Simply, If you test for `--` separately you will get this response : 

![Screenshot (71)](https://github.com/ThatYonko/CyberNights-5/assets/107263975/82e68c5e-43bc-438c-a9e6-7362d687d9a1)
...
![Screenshot (72)](https://github.com/ThatYonko/CyberNights-5/assets/107263975/f2f11291-f4c0-4f01-a8cc-539c20193607)

So if we try out these ways to comment in our query we find that `/*` works and finally we bypassed the WAF! : 

![Screenshot (66)](https://github.com/ThatYonko/CyberNights-5/assets/107263975/457dca36-0e4a-44a2-a091-6fd905c15378)
...
![Screenshot (70) - Copy](https://github.com/ThatYonko/CyberNights-5/assets/107263975/2ba54365-c448-45e1-84d5-22ea92b70442)
...
![Screenshot (67)](https://github.com/ThatYonko/CyberNights-5/assets/107263975/615ff90e-8d27-4490-8f48-2676fce6db87)
...
![Screenshot (68)](https://github.com/ThatYonko/CyberNights-5/assets/107263975/2f4b589d-fbc8-402e-ad9e-af73815add19)

Assuming that the column is named `flag`, we will use the previous script to dump the table. 
<br>
And we finally got the `flag`!

![Screenshot (69)](https://github.com/ThatYonko/CyberNights-5/assets/107263975/68f4a5ac-f925-47a9-8443-6ec824c7fc6d)
